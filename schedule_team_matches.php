...
$matches_query = "
    ...
    FROM team_matches m
    LEFT JOIN group_games mg ON m.id = mg.group_game_id
    LEFT JOIN team_games g ON mg.team_game_id = g.id
    ...
    <div class="main-content">
        ...
        <div class="matches-list">
            <?php if ($matches_result->num_rows > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p class="no-matches">No team matches scheduled yet. Check back later!</p>
            <?php endif; ?>
        </div>

        <?php if ($role === 'host'): ?>
            <div class="add-match-link">
                <a href="add_game.php" class="btn">Add New Team Match</a>
            </div>
        <?php endif; ?>
    </div>
</body>
